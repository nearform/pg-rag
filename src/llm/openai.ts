...
export async function getDocumentDetails(model: OpenAI,file: Buffer):Promise< OpenAI.Chat.Completions.ChatCompletion> {
...
const getOpenAIMessageBody =(imageUrls: ToBase64Response[]):OpenAI.Chat.Completions.ChatCompletionCreateParamsNonStreaming=>{
